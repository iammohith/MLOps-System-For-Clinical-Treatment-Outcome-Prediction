...
## 5. API Design
*(Not applicable. Internal binary artifact boundaries only)*

---

## 6. Execution Flow
*(See `training/README.md` for generation flow; `inference/README.md` for consumption flow)*
